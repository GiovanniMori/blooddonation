...
const UserCard = () => {
  ...
  return (
    <div
      id="cartao"
      className="w-[500px] h-[320px] mx-auto my-32 bg-gradient-to-b from-secondary to-quartenary rounded-xl shadow-xl shadow-white flex flex-col bg-fixed"
    >
      <h2 className="text-3xl font-bold mx-auto pt-6">
        Carteira de doação de sangue
      </h2>
