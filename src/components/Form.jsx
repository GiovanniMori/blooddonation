      ...
      {user ? (
        <div className="bg-secondary py-7 px-12">
          <div className="p-4 font-bold">
            <h1 className="text-4xl text-black font-bold px-16">
            ...
            <div className="flex flex-col px-16 py-3">
              <form onSubmit={handleSubmit((data) => console.log(data))}>
                <div className="flex flex-col mb-4">
                  ...
                  <input
                    className="h-10 rounded-md w-2/3"
                ...
                <input
                  className="bg-primary rounded p-4 font-bold text-base text-white cursor-pointer"
                  type="submit"
                />
              </form>
            </div>
